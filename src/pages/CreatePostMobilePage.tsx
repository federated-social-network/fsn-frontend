                ...
                <div className="flex items-center gap-3 px-4 pt-4 pb-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="text-[11px] text-gray-600 bg-gray-100 hover:bg-gray-200 px-2 py-0.5 rounded-full inline-block mt-0.5 outline-none cursor-pointer appearance-none border border-transparent focus:border-gray-300 transition-colors"
